...
namespace DbModel.Initializers
{
	public static class DbInitializer
	{
		public static void Initialize(FoodContext dbContext)
		{
			...
			{
				new FoodProductItem { FoodProduct = products.First(p => p.Name.Contains("Dry Chicken") || p.Name.Contains("Dry Fish") || p.Name.Contains("Adult Chicken") && p.FoodType == FoodType.DryFood), ContainerType = ContainerType.Bag, WeightInGram = 2000m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Whiskas Adult Dry Chicken"), ContainerType = ContainerType.Bag, WeightInGram = 800m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Purina One Tender Chicken"), ContainerType = ContainerType.Bag, WeightInGram = 1000m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Monge Natural Dry Fish"), ContainerType = ContainerType.Bag, WeightInGram = 400m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Hill's Science Diet Adult"), ContainerType = ContainerType.Bag, WeightInGram = 1500m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Royal Canin Indoor Wet Pouch"), ContainerType = ContainerType.Pouch, WeightInGram = 85m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Applaws Tuna Pouch"), ContainerType = ContainerType.Pouch, WeightInGram = 70m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Iams Adult Wet Salmon"), ContainerType = ContainerType.Can, WeightInGram = 400m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Felix As Good As It Looks"), ContainerType = ContainerType.Tray, WeightInGram = 100m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Sheba Fillet in Sauce"), ContainerType = ContainerType.Tray, WeightInGram = 80m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Tiki Cat Ahi in Broth"), ContainerType = ContainerType.Can, WeightInGram = 70m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Gourmet Perle Duo"), ContainerType = ContainerType.Tray, WeightInGram = 50m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Whiskas Temptations Snacks"), ContainerType = ContainerType.Box, WeightInGram = 60m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Purina Dental Snacks"), ContainerType = ContainerType.Box, WeightInGram = 70m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Applaws Crunchy Treats"), ContainerType = ContainerType.Sachet, WeightInGram = 40m },
				// additional variants
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Whiskas Adult Dry Chicken"), ContainerType = ContainerType.Bag, WeightInGram = 400m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Purina One Tender Chicken"), ContainerType = ContainerType.Bag, WeightInGram = 300m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Iams Adult Wet Salmon"), ContainerType = ContainerType.Can, WeightInGram = 85m },
				new FoodProductItem { FoodProduct = products.First(p => p.Name == "Felix As Good As It Looks"), ContainerType = ContainerType.Tray, WeightInGram = 160m }
			};
